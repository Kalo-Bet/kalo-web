    ...
    return (
        <div className="flex m-[200px] h-screen justify-center items-center">
            <div className="rounded-md p-8 bg-bet-light-bg dark:bg-bet-dark-bg">
                ...
                <button className="mt-[24px] w-full px-12 py-6 font-bold text-[20px] rounded-xl border-2 border-light-text dark:border-dark-text transition-all duration-300 ease-in-out transform hover:scale-105">Share Bet</button>
            </div>
        </div>
    )
}
