            ...
            <div className="rounded-md p-8 bg-bet-light-bg dark:bg-bet-dark-bg">
                ...
                <div className="w-full flex flex-col gap-[32px]">
                    ...
                    <div className="flex gap-[32px]">
                        ...
                        <button onClick={() => {setBetSuccess(true)}} className="self-end w-full px-6 py-3 rounded-lg bg-btn-light dark:bg-btn-dark text-btn-text-light dark:btn-text-dark transition-all duration-300 ease-in-out transform hover:scale-105 hover:bg-btn-hover-light dark:hover:bg-btn-hover-dark">Create Bet</button>
                    </div>
                </div>
            </div>
        </div>
