                    ...
                    <div className="rounded-md p-8 bg-bet-light-bg dark:bg-bet-dark-bg">
                        ...
                        <div className="w-full flex flex-col gap-[32px]">
                            ...
                            <div className="flex gap-[32px]">
                                <div>
                                    <label className="text-[12px] md:text-[16px]">Minimum Stake</label>
                                    <input className="mt-[16px] w-full px-6 py-3 rounded-lg" type="text" placeholder="USDC" />
                                </div>
                                <div>
                                    <label className="text-[12px] md:text-[16px]" htmlFor="">Verification Source</label>
                                    <input className="mt-[16px] w-full px-6 py-3 rounded-lg" type="text" placeholder="" />
                                </div>
                            </div>
                            <div className="flex gap-[32px]">
                                <div className="self-start w-full">
                                    <label className="text-[12px] md:text-[16px]">Set Deadline for Bet*</label>
                            ...
                            <div className="flex gap-[32px]">
                                <div className="w-full self-start">
                                    <label className="text-[12px] md:text-[16px]" htmlFor="">Stake Amount</label>
